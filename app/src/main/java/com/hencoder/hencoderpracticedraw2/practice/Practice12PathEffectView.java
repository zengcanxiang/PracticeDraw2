...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        CornerPathEffect cornerPathEffect = new CornerPathEffect(15);
        ...
        // 第三处：DashPathEffect
        DashPathEffect dashPathEffect=new DashPathEffect(new float[]{20,0},3);
        ...
        PathDashPathEffect pathDashPathEffect=new PathDashPathEffect(p,20,5, PathDashPathEffect.Style.ROTATE);
